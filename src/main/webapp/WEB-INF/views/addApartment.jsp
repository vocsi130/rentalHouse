...
<t:master>
	...
	<jsp:body>
		           <form:form modelAttribute="apartment"  methode ="post">
    ...
    <div style="float: right;">
				...
				<a href="/apartmentList" class="btn btn-outline-warning"
					style="margin-right: 2em;">Cancel</a>
				<button id="btnSubmit" type="submit" class="btn btn-outline-primary">Add Apartment
					</button>
			</div>
