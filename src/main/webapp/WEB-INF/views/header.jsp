						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
										<a href="addHouse">
											<span class="sub-item">Add House</span>
										</a>
									</li>
									<li>
										<a href="addApartment">
											<span class="sub-item">Add Apartment</span>
										</a>
									</li>
									<li>
										<a href="houses">
											<span class="sub-item">List House</span>
										</a>
									</li>
									<li>
										<a href="apartment">
											<span class="sub-item">List Apartment</span>
										</a>
									</li>
									<li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="forms">
								<ul class="nav nav-collapse">
									<li>
										<a href="addContract">
											<span class="sub-item">Add New Contract</span>
										</a>
									</li>
								<li>
										<a href="forms/forms.html">
											<span class="sub-item">Remplacement Contract</span>
										</a>
									</li>
								
								<li>
										<a href="contractActive">
											<span class="sub-item">Contract Active</span>
										</a>
									</li>
									<li>
										<a href="forms/forms.html">
											<span class="sub-item">Contract Ending</span>
										</a>
									</li>
								
								<li>
										<a href="contracts">
											<span class="sub-item">Contract List</span>
										</a>
									</li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="tables">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="paymentInactive">
											<span class="sub-item">Payment Inactive</span>
										</a>
									</li>
									<li>
										<a href="paymentIncorrect">
											<span class="sub-item">Payment Incorrect</span>
										</a>
									</li>
									<li>
										<a href="payments">
				 ...
				 <div class="page-inner mt--10">
					<div class="row mt--6">
                          ...
                          <div class="col-lg-10">
                              ...
                              <div class="form-group">
                                <label for="exampleInputPassword1">Password</label>
                                <input class="form-control" id="exampleInputText" type="text" placeholder="name">
                              </div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<div class="copyright ml-auto">
					 &copy 2019<i class="fa fa-edit edit text-danger"></i>
					</div>				
				</div>
			</footer>
		</div>
